    ...
    for rng in RNGs:
        ...
        for n in range(1000, 50001, 1000):
            ...
            for _ in range(k):
                ...
                # For each sorting algorithm, run it with the RNG output
                for sort_algo in sorting_algorithms:
                    split = sort_algo.split(" ")

                    # Create the path for the RNG command to run
                    rng_command = [RNGs_path + rng, str(n), str(1), split[1]]
                    ...
                    sort_command = [sorting_algorithms_path + split[0]]
        ...
        comparisons_filename = f"./plots/k{k}_{rng}_comparisons_maxn50.png"
        ...
        # Save the plot with a dynamic filename
        swaps_filename = f"./plots/k{k}_{rng}_swaps_maxn50.png"
        ...
        comparisons_dn_filename = f"./plots/k{k}_{rng}_comparisonsDn_maxn50.png"
        ...
        swaps_dn_filename = f"./plots/k{k}_{rng}_swapsDn_maxn50.png"
