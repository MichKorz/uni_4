...
sorting_algorithms_path = "../task_3/"
...
for k in [1]:
    ...
    for rng in RNGs:
        ...
        comparisons_filename = f"./plots_3/k{k}_{rng}_comparisons_maxn50000.png"
        ...
        # Save the plot with a dynamic filename
        swaps_filename = f"./plots_3/k{k}_{rng}_swaps_maxn50000.png"
        ...
        comparisons_dn_filename = f"./plots_3/k{k}_{rng}_comparisonsDn_maxn50000.png"
        ...
        swaps_dn_filename = f"./plots_3/k{k}_{rng}_swapsDn_maxn50000.png"
