...
os.makedirs("./plots_2a", exist_ok=True)
...
for k in [1, 10, 100]:
    ...
    for rng in RNGs:
        ...
        comparisons_filename = f"./plots_2a/k{k}_{rng}_comparisons_maxn50.png"
        ...
        # Save the plot with a dynamic filename
        swaps_filename = f"./plots_2a/k{k}_{rng}_swaps_maxn50.png"
        ...
        comparisons_dn_filename = f"./plots_2a/k{k}_{rng}_comparisonsDn_maxn50.png"
        ...
        swaps_dn_filename = f"./plots_2a/k{k}_{rng}_swapsDn_maxn50.png"
